<template>
    <div class="card">
        ...
        <div class="card-body"> 
            ...
            <label for="">Inscripción de Recursos Gestión {{gestion_activa.gestion}}</label>
            <div class="row">
                <div class="col-md-3">          
                ...
                <div class="col-md-3">          
                    ...
                    <v-select label="nombre" :options="comboTipoMovimiento" v-model="jsonData.tipo_movimiento" placeholder="Selecione un Cofinanciador" disabled>
                    ...
                    <div class="col-md-3"><br><br>
                        <div class="row">
                            ...
                            <div class="col-md-12 p-2" v-if="btnimprimirestructura">
                                ...
                                <a :href="'../Reportes/ficha_proyecto_estructura_financiamiento2/' + jsonData.comprobante_encabezado_id" target="_blank" rel="">
...
export default {
    ...
    data(){
        return{
            ...
            jsonData:{
                ...
                tipo_movimiento:{
                    id:3,
                    nombre:'inscripción presupuestaria',
                    sigla:'IN',
                    created_at:null,
                    updated_at:null,
                },
    ...
    methods:{
        async gestiones_activa_poa(){
            ...
            this.gestion_activa = {"gestion":respuesta.data[0].gestion, "id":1};
            this.jsonData.gestion = this.gestion_activa.gestion;
        },
        ...
        async verifica_encabezado(){
            // console.log();
            var respuesta = await axios.post('buscando_encabezado', this.jsonData);
            // console.log(respuesta.data);
            if(respuesta.data.id != 'undefined' && respuesta.data.id != null && respuesta.data.id != undefined){                
                this.jsonData.comprobante_encabezado_id = respuesta.data.id;
