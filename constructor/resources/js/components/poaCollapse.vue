                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-rigth">   
                        <div class="btn-group">           
                            ...
                            <button class="btn btn-warning" title="Resultados e Indicadores" @click="resultado(ferd_variable_collapse)">
            ...
            <b-card>     
                ...
                <div v-else>                    
                    <div v-for="dependiente in ferd_variable_collapse.dependientes" :key="dependiente.id">
                        <poa-collapse  :ferd_variable_collapse="dependiente" @escuchaArbol="respuestaSubArbol" ref="llamarSubArbol"></poa-collapse>
                    </div> 
                </div>                           
            </b-card>                
        </b-collapse>
