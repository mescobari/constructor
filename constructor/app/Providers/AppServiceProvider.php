...
class AppServiceProvider extends ServiceProvider
{
    ...
    {        
        ...
        View::share('sistemas_ferchos', 'EL CONSTRUCTOR');
        ...
        View::share('sistemas_ferchos_boton_guardar', 'btn-warning');//guardar
        ...
        //desarrollador
        View::share('sistemas_ferchos_nombre_desarrollador', 'Max Escobari Quiroga');
        View::share('sistemas_ferchos_nombre_corporacion', 'Innovacion Quantica S.R.L.');
    }
}
