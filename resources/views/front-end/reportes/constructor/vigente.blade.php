            ...
            <table class="styled-table" >
                <thead>
                    ...
                    <tr align="center">
                        ...
                        <th colspan='3'><b>Planilla Inicial</b></th>
                        <th colspan='3'><b>Planilla Vigente</b></th>
                        <th colspan='3'><b>Diferencia</b></th>                       
                    </tr>
                    <tr align="center">
                        <th><b>Codigo</b></th>  
                ...
                <tbody>
                     @for ($i = 0; $i <  count($planilla); $i++)
                        ...
                        @endif
                            ...
                            <td align="right">{{$planilla[$i]['inic_cant']}}</td>  
                            <td align="right">{{$planilla[$i]['inic_pu']}}</td> 
                            <td align="right" width="15%">{{$planilla[$i]['inic_pt']}}</td>
