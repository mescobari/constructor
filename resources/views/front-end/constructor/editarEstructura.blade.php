    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header {{$sistemas_ferchos_color_cabeceras_formulario}}">
                <h3 class="card-title">Editar Concepto Estructura de Obra</h3>
            ...
            <form action="{{route('actualizar_menu')}}" id="form-general" class="form-horizontal form--label-right" method="POST">
                @csrf
