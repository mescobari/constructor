    ...
    <div>
        <div class="card">
            <div class="card-header ferdy-background-Primary-blak">
                <h3 class="card-title">PROGRAMACION DE HITOS - ENTREGABLES</h3>
            ...
            <hr>
      <!--  fin formulario en programacion //////////--> 
      ...
      <div class="row">
        <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-6">          
                    <div class="form-group">
                        <label for="fecha_aprobacion">Fecha de Inicial:</label>
                ...
                <div class="col-md-6">          
                    <div class="form-group">
                        <label for="fecha_aprobacion">Fecha de Final:</label>
                        <!-- <input type="date" class="form-control" name="fecha_aprobacion" v-model="jsonData.fecha_aprobacion"> -->
                        <datepicker             
                            :language="configFechas.es"
                            :placeholder="configFechas.placeholder"
