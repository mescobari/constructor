<?php
    Route::group(['prefix' => 'paginas', 'namespace' => 'Front_End\Constructor'], function () {
        ...
        Route::get('ver_ficha/{id}', 'PlanillaReportesController@ver_ficha')->name('ver_ficha');
        Route::get('gra_financiero/{id}', 'PlanillaReportesController@avance_financiero')->name('gra_financiero');
